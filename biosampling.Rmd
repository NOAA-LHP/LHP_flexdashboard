...
#subset data 
data<-data |> subset(ScientificName %in% BMUS)

#fix common names to only one per scientific name
#unique(data$CommonName)

cname<-c("SILVERMOUTH", "GIANT TREVALLY", "BLACK JACK", "EHU SNAPPER", "ONAGA SNAPPER", "REDGILL EMPEROR", "BLUELINED SNAPPER", "YELLOWTAIL KALIKALI", "PINK OPAKAPAKA", "YELLOWEYE OPAKAPAKA","KALIKALI","GINDAI", "LYRETAIL GROUPER")

temp<-data.frame(ScientificName=BMUS, CommonName=cname)
