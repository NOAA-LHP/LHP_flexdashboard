...
```{r}
#build data dictionary = Species/Name
vals=reactiveValues(ScientificName=FALSE,CommonName=FALSE)
...
vals$ScientificName=TRUE
vals$CommonName=FALSE
})

observeEvent(input$Name,{
vals$ScientificName=FALSE
vals$CommonName=TRUE
})
